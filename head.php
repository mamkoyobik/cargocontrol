...
$faqEntities = [
    [
        'question' => 'Зачем нужен сюрвей.',
        'answer' => 'Прибегая к услугам грузовых сюрвейеров, Вы защищаете компанию от распространенных убытков и порчи товаров, связанных с нарушением условий хранения, перемещения и проведения погрузочно-разгрузочных работ. Сюрвей включает в себя осмотр состояния и непредвзятую экспертную оценку качества и количества груза, пригодности транспорта к его приему и перемещени, исправности оборудования.',
    ],
    [
        'question' => 'Что делает сюрвейер.',
        'answer' => 'Наши независимые сюрвейеры произведут инспекцию перевозимых товарно-материальных ценностей, а также места и условий хранения Вашего груза. Исходя из результатов проведённых работ, определяется количественный и качественный состав товара, состояние складских помещений и пригодность транспортных средств.',
    ],
    [
        'question' => 'Что входит в инспекцию.',
        'answer' => 'Наша сюрвейерская инспекция включает в себя множество проверок, осмотров и контроля, чтобы не упустить ни одного нюанса: проверка технического состояния транспортных средств, проверка транспортных и товаросопроводительных документов, осмотр состояния груза, контроль процесса погрузки и другие операции.',
    ],
    [
        'question' => 'Независимая оценка и достоверная информация.',
        'answer' => 'CARGO CONTROL выступает в роли независимой компании, а значит, сюрвейерская инспекция производится объективно и непредвзято. Мы готовы предоставить непредвзятую и достоверную информацию, подтверждением которой будут все необходимые материалы и документы, полученные по результатам инспекции.',
    ],
];

$faqMainEntity = array_map(static function ($item) {
    return [
        '@type' => 'Question',
        'name' => $item['question'],
        'acceptedAnswer' => [
...
$schema = [
    ...
    '@graph' => [
        ...
        [
            ...
            'name' => ['Главная', 'Услуги', 'Фотогалерея', 'Контакты', 'о нас'],
            'url' => [
                $siteUrl . '#land',
                $siteUrl . '#services',
                $siteUrl . '#gallery',
...
<link rel="preload" as="image" href="/img/logo-white.png">
